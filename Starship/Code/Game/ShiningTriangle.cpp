...
void ShiningTriangle::UpdateAlphaColor(float deltaSeconds)
{
	...
	if (g_theApp->m_permitToStartTimer)
	{
...
{
	m_localVerts[0].m_position = Vec3(-5.f, 5.f, 0.f);
	m_localVerts[1].m_position = Vec3(-5.f, -5.f, 0.f);
	m_localVerts[2].m_position = Vec3(9.f, 0.f, 0.f);
