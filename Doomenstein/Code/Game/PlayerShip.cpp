...
void PlayerShip::Update()
{
	...
	m_angularVelocity_float = 0.f;	// angular velocity will reset to 0 when key released
	...
	{
		m_angularVelocity_float += PLAYERSHIP_TURNRATE;
	}
...
{
	// nose
	m_localVerts[0].m_position = Vec3(1.f, 0.f, 1.f);
	m_localVerts[1].m_position = Vec3(0.f, 1.f, 1.f);
	m_localVerts[2].m_position = Vec3(0.f, -1.f, 1.f);
